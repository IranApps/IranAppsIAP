...
public class IranAppsIABEventListener : MonoBehaviour
{
//#if UNITY_ANDROID
	...
	void queryInventorySucceededEvent(List<IranAppsPurchase> purchases, List<IranAppsSkuInfo> skus)
	{
    ...
    private void querySkuDetailsSucceededEvent(List<IranAppsSkuInfo> skus)
    {
    ...
    private void queryPurchasesSucceededEvent(List<IranAppsPurchase> purchases)
    {
    ...
    void purchaseSucceededEvent(IranAppsPurchase purchase)
	{
	...
	void consumePurchaseSucceededEvent(IranAppsPurchase purchase)
	{
