...
namespace IranAppsPlugin
{
    public class IranAppsIAB
    {
        ...
        static IranAppsIAB()
        {
            ...
            using (var pluginClass = new AndroidJavaClass("com.iranapps.IranAppsIABPlugin"))
        ...
        // Sends a request to get all completed purchases and product information as setup in the IranApps portal about the provided skus
        ...
        // Sends a request to get all product information as setup in the IranApps portal about the provided skus
