...
import com.iranapps.util.IabHelper;
import com.iranapps.util.IabResult;
import com.iranapps.util.Inventory;
import com.iranapps.util.Purchase;
import com.iranapps.util.SkuDetails;
...
public class IranAppsIABPlugin extends IranAppsIABPluginBase
	implements 
	...
	, IabHelper.OnConsumeMultiFinishedListener
{
	...
	public void queryInventory(final String[] skus)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				mHelper.queryInventoryAsync(true, Arrays.asList(skus), IranAppsIABPlugin.this);
			}
	...
	public void querySkuDetails(final String[] skus)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				mHelper.querySkuDetailsAsync(Arrays.asList(skus), IranAppsIABPlugin.this);
			}
	...
	public void queryPurchases()
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				mHelper.queryPurchasesAsync(IranAppsIABPlugin.this);
			}
		}, "queryInventoryFailed");
	}
	...
	public void purchaseProduct(final String sku, final String developerPayload)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				Intent proxyStarter = new Intent(getActivity(), IranAppsIABProxyActivity.class);
	...
	public void consumeProduct(String sku)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				mHelper.consumeAsync(purchase, IranAppsIABPlugin.this);
			}
	...
	public void consumeProducts(String[] skus)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				mHelper.consumeAsync(confirmedPurchases, IranAppsIABPlugin.this);
			}
		}, "consumePurchaseFailed");
	}
